...
def get_state_from_fields(fields):
    return[np.array(np.concatenate( (fields['position'], fields['targetPosition']))), None]
...
def make_env_def():
        ...
        #DISABLE52environment_definitions['extra_inputs_shape'] = (6,)
        #NETWORKenvironment_definitions['make_inference_network'] = make_inference_network
        environment_definitions['action_shape'] = (4, )
        environment_definitions['actions'] = [('Move',[1, 0, 0]),('Move',[-1, 0, 0]),('Move',[0, 0, 1]),('Move',[0, 0, -1])]
